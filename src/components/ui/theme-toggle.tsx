...
export function ThemeToggle() {
    ...
    if (!mounted) {
        return (
            <button className="fixed top-4 right-4 p-2 w-9 h-9 text-muted-foreground">
    ...
    return (
        <button
            ...
            className="fixed top-4 right-4 p-2 w-9 h-9 text-muted-foreground hover:text-foreground transition-colors"
            title="Toggle theme"
        >
